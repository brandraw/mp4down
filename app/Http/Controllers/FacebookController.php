...
class FacebookController extends Controller
{
    public function index()
    {
        return view("welcome", [
            ...
            "faqs" => [
                ["question" => __("Why can't I download regular videos?"), "answer" => __("Only Facebook reels videos can be downloaded. You can't download regular videos.")],
                
            ],
            "updates" => [
                ["title" => __("START (2 July 2023):"), "description" => __("Welcome to MP4DOWN. Download Facebook reels videos completely free of charge. You can own any video you want, completely free of charge.")],
                ["title" => __("UPDATE (2 July 2023):"), "description" => __("We fixed issues with downloads failing and minor errors.")]
            ]
        ]);
    }
